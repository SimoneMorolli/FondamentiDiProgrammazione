...
def power_recursive(base: int, exp: int) -> int:
    ...
    if exp == 1:
        ...
        newNumber = base * power_recursive(base, exp - 1)
    return newNumber
...
#
# Siano i paletti etichettati con A, B e C, e i dischi numerati da n (il più piccolo) a 1 (il più grande).
